<x-adminpanel::layouts.app title="Dashboard">
    <div class="space-y-6">
        <section class="relative overflow-hidden rounded-2xl border border-primary/15 bg-linear-to-br from-primary/10 via-base-100 to-base-100 p-5 shadow-sm sm:p-7">
            ...
            <div class="relative">
                ...
                <h1 class="mt-2 text-2xl font-bold tracking-tight sm:text-3xl">Skeleton siap dikembangkan</h1>
                <p class="text-base-content/60 mt-3 max-w-2xl text-sm leading-6 sm:text-base">
                    Fondasi autentikasi, manajemen akses, upload privat, activity log, keamanan, dan import/export sudah tersedia.
                </p>
            </div>
        </section>
        ...
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            <article class="card border border-base-content/10 p-5 shadow-sm">
                <div class="flex items-center justify-between gap-4">
                    <div><p class="text-base-content/60 text-sm">Pengguna aktif</p><p class="mt-2 text-3xl font-bold">{{ number_format($activeUsersCount) }}</p></div>
            ...
            <article class="card border border-base-content/10 p-5 shadow-sm">
                <div class="flex items-center justify-between gap-4">
                    <div><p class="text-base-content/60 text-sm">Role</p><p class="mt-2 text-3xl font-bold">{{ number_format($rolesCount) }}</p></div>
            ...
            <article class="card border border-base-content/10 p-5 shadow-sm">
                <div class="flex items-center justify-between gap-4">
                    <div><p class="text-base-content/60 text-sm">Permission</p><p class="mt-2 text-3xl font-bold">{{ number_format($permissionsCount) }}</p></div>
