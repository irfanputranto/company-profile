...
use App\Modules\CompanyProfile\Controllers\PublicAboutController;
...
use App\Modules\CompanyProfile\Controllers\PublicContentPageController;
...
Route::get('/pages/{contentPage:slug}', PublicContentPageController::class)->name('pages.show');
